...
def localeInit():
	...
	# gettext.bindtextdomain("iFlatVWeather2", "%s%s" % (resolveFilename(SCOPE_PLUGINS), "Extensions/iFlatVWeather2/locale/")) #			po/mo files?
	return str(lang)

weather_data = None
current_language = localeInit()

class NFRYahooWeather(Converter, object):
