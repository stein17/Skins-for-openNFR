...
def Plugins(**kwargs):
    return [PluginDescriptor(name=_("NFR_Skin HD Configtool"), description=_("Personalize your NFR_Skin HD (Skin by stein17)"), where = [PluginDescriptor.WHERE_PLUGINMENU],
...
def main(session, **kwargs):
    if config.skin.primary_skin.value == "NFR_Skin/skin.xml":
        ...
        AddPopup(_('Please activate NFR_Skin HD Skin before run the Config Plugin'), type=MessageBox.TYPE_ERROR, timeout=10)
        return []
...
class NFR_Skin_Config(Screen, ConfigListScreen):
    ...
    def getInitConfig(self):
        ...
        self.default_font_size_file = "font_size_Original.xml"
        ...
        self.font_size_file = "skin_user_font_size.xml"
    ...
    # background
        ...
        # font_size
        current, choices = self.getSettings(self.default_font_size_file, self.font_size_file)
        self.myAtileHD_font_size = NoSave(ConfigSelection(default=current, choices = choices))
        # ch_se_color
    ...
    def createConfigList(self):
        ...
        self.set_infobar_color = getConfigListEntry(_("Infobar_Color:"), self.myAtileHD_infobar_color)
        self.set_font_size = getConfigListEntry(_("Font_size_Menu:"), self.myAtileHD_font_size)
        ...
        if self.myAtileHD_active.value:
            ...
            if len(self.myAtileHD_font_size.choices)>1:
                self.list.append(self.set_font_size)
    ...
    def changedEntry(self):
        ...
        elif self["config"].getCurrent() == self.set_font_size:
            self.setPicture(self.myAtileHD_font_size.value)
    ...
    def keyGreen(self):
        if self["config"].isChanged():
            ...
            # font_size
            self.makeSettings(self.myAtileHD_font_size, self.font_size_file)
            # ch_se_color
