...
config.plugins.Ultimate.refreshInterval = ConfigNumber(default=10)
config.plugins.Ultimate.woeid = ConfigNumber(default = 638242)
config.plugins.Ultimate.tempUnit = ConfigSelection(default="Celsius", choices = [
                                ("Celsius", _("Celsius")),
